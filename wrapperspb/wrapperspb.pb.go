...
const file_wrapperspb_wrapperspb_proto_rawDesc = "" +
	"\n" +
	"\x1bwrapperspb/wrapperspb.proto\x12\x0fopenim.protobuf\"#\n" +
...
var (
	...
	file_wrapperspb_wrapperspb_proto_rawDescData []byte
)

func file_wrapperspb_wrapperspb_proto_rawDescGZIP() []byte {
	file_wrapperspb_wrapperspb_proto_rawDescOnce.Do(func() {
		file_wrapperspb_wrapperspb_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wrapperspb_wrapperspb_proto_rawDesc), len(file_wrapperspb_wrapperspb_proto_rawDesc)))
	})
...
func file_wrapperspb_wrapperspb_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wrapperspb_wrapperspb_proto_rawDesc), len(file_wrapperspb_wrapperspb_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
